...
ListView.include({
	...
	export_to_excel: function(export_type) {
            ...
            // Find Header Element
            var header_eles = self.$el.find('.table-responsive > table > thead > tr')
            if (header_eles.length === 0) {
            ...
            //Find Data Element
            var data_eles = self.$el.find('.table-responsive > table > tbody > tr')
            if (data_eles.length === 0) {
...
//	                        text = instance.web.parse_value(text, { type:"float" })
            ...
            var footer_eles = self.$el.find('.table-responsive > table > tfoot> tr')
            if (data_eles.length === 0) {
